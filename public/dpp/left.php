         ...
         <div class="sidebar">
            <div class="sidebar-content email-app-sidebar d-flex">
               ...
               <div class="email-app-menu">
                  <div class="form-group form-group-compose text-center compose-btn d-none">
                     <button type="button" class="btn btn-primary btn-block my-2" data-toggle="modal"
                        data-target="#composeForm"><i class="feather-edit"></i> Compose</button>
                  </div>
                  <div class="mb-1"></div>
                  <div class="sidebar-menu-list">
                     <div class="list-group list-group-messages font-medium-1" id="inner-menu">
                        ...
                        <!-- <a href="#" class="list-group-item list-group-item-action border-0"><i
                           class="font-medium-5 feather-edit-2 mr-50"></i> All Cases <span
                        ...
                        <i class="font-medium-5 feather-mail mr-50"></i>  Requests<span
                           class="badge badge-primary badge-pill float-right" id="countRequest"><?php echo count(Advice::find_advice(['reply' => 0])); ?></span>
                        </a>

                        <a href="replied.php" class="list-group-item list-group-item-action border-0 
                        <?php echo $page_title == 'Replied' ? 'active' : '' ?>" data-id="2"><i
                           class="font-medium-5 fa fa-paper-plane-o mr-50"></i> Replied Requests<span  
                           class="badge badge-warning badge-pill float-right" id="countReplied"><?php echo count(Advice::find_advice(['reply' => 1])); ?></span> </a>
                        ...
                        <?php echo $page_title == 'All Cases' ? 'active' : '' ?>" data-id="3">
                         ...
                         Cases in court <span class="badge badge-danger badge-pill float-right">
                            <?php echo count(CourtCase::find_by_client_id($loggedInAdmin->id)) ?>
                         </span> </a>

                     </div>
                     <hr>
                     <?php if($loggedInAdmin->rank == 1) { ?>
