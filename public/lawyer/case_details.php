        ...
        <div class="col-lg-9 col-md-7 col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="images/kb-article.jpg" class="img-fluid rounded-sm mb-1 w-100" alt="artilcle-img">
                    <p>
                    ...
                    <ul class="article-question p-0 list-unstyled">
                        <li><i class="feather-chevrons-right"></i> <span>Pastry jelly chocolate bar caramels</span></li>
                        <li><i class="feather-chevrons-right"></i><span>Donut chupa chups oat cake</span></li>
                        <li><i class="feather-chevrons-right"></i><span>Marshmallow icing topping toffee caramels dessert carrot cake</span></li>
                    </ul>
                    <p class="mt-2">
