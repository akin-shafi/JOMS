...
$transactions = Transaction::find_by_approved();
		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">
						<span class="text-uppercase">All Approved Transaction</span> |
						<span class="text-muted">Filed Cases and Documents</span></h4>
				</div>
				<div class="card-content">
					<div class="card-body card-dashboard">
						<p class="card-text">The table below displays all approved transactions for the year <?php echo date('Y') ?>.
						</p>
								...
								<tbody>
									...
									foreach ($transactions as $transaction) { ?>
										<tr>
											...
											<td style="font-size: 10px;"><?php echo $transaction->payment_mode ? 'POS' : 'e-payment'; ?></td>
											<td style="font-size: 10px;"><?php echo Clients::find_by_id(CourtCase::find_by_id($transaction->case_id)->client_id)->full_name(); ?></td>
