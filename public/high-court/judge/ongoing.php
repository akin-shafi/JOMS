...
<div class="row d-flex justify-content-between">
  <div class="col-lg-3 col-sm-6 col-12">
    <a href="<?php echo url_for('/high-court/judge/ongoing.php'); ?>">
      <div class="card">
        <div class="card-header d-flex align-items-start pb-0">
          <div>
            <h2 class="text-bold-700 mb-0"><?php echo count(Task::find_by_unassigned()); ?></h2>
            <p class="text-danger text-bold-700">ONGOING</p>
          </div>
  ...
  <div class="col-lg-3 col-sm-6 col-12">
    <a href="<?php echo url_for('/high-court/judge/completed.php'); ?>">
      <div class="card">
        <div class="card-header d-flex align-items-start pb-0">
          <div>
            <h2 class="text-bold-700 mb-0"><?php echo count(Task::find_by_assigned()); ?></h2>
            <p class="text-success text-bold-700">COMPLETED</p>
          </div>
              ...
              <table class="table table-sm table-striped dataex-html5-selectors">
                <thead>
                  <tr>
                    ...
                    <th style="font-size: 10px;">Last Hearing</th>
                    <th style="font-size: 10px;">Next Hearing</th>
                    <th style="font-size: 10px;">Court Type</th>
                    <th style="font-size: 10px;">Division</th>
                    <th style="font-size: 10px;">Court Room</th>
                    <th style="font-size: 10px;">Evidence</th>
                ...
                <tbody>
                  ...
                  foreach ($transactions as $transaction) { ?>
                    <tr>
                      ...
                      <td style="font-size: 10px;"><?php echo $transaction->status; ?></td>
                      ...
                      <td style="font-size: 10px;"><?php echo $transaction->last_hearing; ?></td>
                      <td style="font-size: 10px;"><?php echo $transaction->next_hearing; ?></td>
                      ...
                      <td style="font-size: 10px;"><?php echo $transaction->evidence; ?></td>
