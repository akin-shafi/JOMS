      ...
      <div class="card alert-success">
        <div class="card-header d-flex align-items-start pb-0">
          <div>
            ...
            <p class="text-dark text-bold-700">ALL CASES <?php echo date('(M. dS)'); ?></p>
          </div>
      ...
      <div class="card alert-danger">
        <div class="card-header d-flex align-items-start pb-0">
          <div>
            ...
            <p class="text-danger text-bold-700">SENTENCED</p>
          </div>
          <div class="avatar bg-rgba-danger p-50 m-0">
            <div class="avatar-content">
              <i class="feather-alert-octagon text-danger font-medium-5"></i>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card alert-info">
        <div class="card-header d-flex align-items-start pb-0">
          <div>
            ...
            <p class="text-dark text-bold-700">REMANDED</p>
          </div>
          <div class="avatar bg-rgba-info p-50 m-0">
            <div class="avatar-content">
              <i class="feather-alert-octagon text-info font-medium-5"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <a href="<?php echo url_for('/high-court/judge/assigned.php'); ?>">
      <div class="card">
        <div class="card-header d-flex align-items-start pb-0">
          <div>
            <h2 class="text-bold-700 mb-0"><?php echo count(Task::find_by_assigned()); ?></h2>
            <p class="text-info text-bold-700">ASSIGNED</p>
          </div>
          <div class="avatar bg-rgba-info p-50 m-0">
            <div class="avatar-content">
              <i class="feather-alert-octagon text-info font-medium-5"></i>
    ...
    <a href="<?php echo url_for('/high-court/judge/assigned.php'); ?>">
      <div class="card">
        <div class="card-header d-flex align-items-start pb-0">
          <div>
            <h2 class="text-bold-700 mb-0"><?php echo count(Task::find_by_assigned()); ?></h2>
            <p class="text-warning text-bold-700">ONGOING</p>
          </div>
                ...
                <tbody>
                  ...
                  foreach ($transactions as $transaction) { ?>
                    <tr>
                      ...
                      <td style="font-size: 10px;"><button class="btn btn-sm btn-info"><i class="feather-thumbs-up"></i> Assign</button></td>
                    </tr>
                  <?php } ?>
                </tbody>
                <tfoot>
