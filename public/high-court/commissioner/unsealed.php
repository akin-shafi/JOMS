...
$transactions = Transaction::find_by_unsealed();

// echo '<pre>';print_r($transactions);echo '</pre>';

?>
<?php $page_name = 'Bursar';
$page_title = 'All Un-sealed';  ?>
		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">
						<span class="text-uppercase">All Un-sealed Transactions</span> |
						<span class="text-muted">Filed Cases and Documents</span></h4>
				</div>
				<div class="card-content">
					<div class="card-body card-dashboard">
						<p class="card-text">The table below displays all un-sealed transactions for the year <?php echo date('Y') ?>.
						</p>
