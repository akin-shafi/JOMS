    ...
    <a href="<?php echo url_for('/high-court/registrar/assigned.php'); ?>">
      <div class="card">
        <div class="card-header d-flex align-items-start pb-0">
          <div>
            <h2 class="text-bold-700 mb-0" id="recent_cases"><?php //echo count($transactions); ?></h2>
  ...
  <div class="col-lg-3 col-sm-6 col-12">
    <a href="<?php echo url_for('/high-court/registrar/unassigned.php'); ?>">
      <div class="card">
        <div class="card-header d-flex align-items-start pb-0">
          <div>
            <h2 class="text-bold-700 mb-0" id="unassigned"><?php //echo count(CourtCase::find_by_unassigned()); ?></h2>
  ...
  <div class="col-lg-3 col-sm-6 col-12">
    <a href="<?php echo url_for('/high-court/registrar/assigned.php'); ?>">
      <div class="card">
        <div class="card-header d-flex align-items-start pb-0">
          <div>
            <h2 class="text-bold-700 mb-0" id="assigned"><?php //echo count(CourtCase::find_by_assigned()); ?></h2>
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <select name="judge_incharge_id" class="form-control select2 w-100 mt-1" id="judge_incharge_id">
              ...
              <?php foreach (Admin::find_all_judge() as $add) { ?>
  ...
  $(document).ready(function() {
    ...
    function counted_data() {
      $.ajax({
        ...
        dataType: 'json',
        success: function(r) {
          $('#recent_cases').text(r.recent_cases);
          $('#unassigned').text(r.unassigned);
          $('#assigned').text(r.assigned);
        }
      });
    }
