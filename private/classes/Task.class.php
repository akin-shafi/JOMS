...
class Task extends DatabaseObject
{
  ...
  static protected $db_columns = ['id', 'case_name', 'submitted_on', 'type_of_matter', 'case_description', 'assigned_by', 'case_number', 'assigned_to', 'date_assigned', 'last_hearing', 'next_hearing', 'status', 'court_type', 'division', 'court_room', 'uploads', 'evidence', 'assigned', 'created_at', 'deleted'];
  ...
  public function __construct($args = [])
  {
    ...
    $this->submitted_on = $args['submitted_on'] ?? date('Y-m-d H:i:s');
    ...
    $this->last_hearing = $args['last_hearing'] ?? date('Y-m-d H:i:s');
    $this->next_hearing = $args['next_hearing'] ?? date('Y-m-d H:i:s');
