...
class Technician extends DatabaseObject {

  static protected $table_name = "technicians";
  static protected $db_columns = ['id', 'first_name', 'last_name', 'username', 'email', 'phone', 'hashed_password', 'address', 'state', 'user_type', 'profile_img', 'created_by', 'created_at', 'deleted'];
  ...
  protected function validate() {
    ...
    }elseif (!has_unique_email_technician($this->email, $this->email ?? 0)) {
    ...
    } elseif (!has_unique_username_technician($this->username, $this->id ?? 0)) {
