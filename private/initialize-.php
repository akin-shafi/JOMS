<?php
  ...
  define("WWW_ROOT", '/newjoms/public');
  // define("WWW_ROOT", '');
  ...
  } elseif ($session->technician_id) { //for riders session

    $loggedInAdmin = Technician::find_by_id($session->technician_id);

  } elseif ($session->customer_id){ //for customers session

    $loggedInAdmin = Customer::find_by_id($session->customer_id);
